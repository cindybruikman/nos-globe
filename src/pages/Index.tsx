...
import { newsStories, getStoriesByCategory, getStoriesBySearch, NewsStory } from "@/utils/mockData";
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (activeCategory) {
      toast.info(`${filteredStories.length} verhalen in deze categorie gevonden`);
    }
  }, [activeCategory]);
